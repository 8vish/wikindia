...
const arcana2Combos = [
    ...
    {'source': ['Priestess',  'Strength',   ], 'result': 'Justice'     },
    //{'source': ['Priestess',  'Strength',   ], 'result': 'Hierophant'  }, // Error in Persona 4: Official Strategy Guide
    ...
    {'source': ['Fortune',    'Star',       ], 'result': 'Emperor'     },
...
const arcana3Combos = [
    ...
    {'source': ['Chariot',    'Lovers',     ], 'result': 'Hermit'  },
    ...
    {'source': ['Temperance', 'Hanged Man', ], 'result': 'Judgement'     },
    ...
    {'source': ['Sun',        'Lovers',     ], 'result': 'Emperor'     },
